...
<Info>
This uses the same endpoint as [Clear Invoice](/api-reference/invoices/clear-invoice). The only difference is `invoice_type: "simplified"` instead of `"standard"`. See [Working with Documents](/guides/working-with-documents) for how clearance and reporting relate.
</Info>
